...
func TestX(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_x.csv")
...
func TestVerifier(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_verifier.csv")
...
func TestServerPublicKey(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_server_public_key.csv")
...
func TestCalculateU(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_u.csv")
...
func TestServerSKey(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_server_s.csv")
...
func TestInterleave(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_interleaved.csv")
...
func TestServerSessionKey(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_server_session_key.csv")
