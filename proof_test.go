...
func TestClientProof(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_client_proof.csv")
...
func TestServerProof(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_server_proof.csv")
...
func TestReconnectProof(t *testing.T) {
	rows := internal.MustLoadTestData("testdata/calculate_reconnect_proof.csv")
